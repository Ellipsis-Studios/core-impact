...
private:
    ...
    uint16_t _planetStardustPerLayer;
...
#pragma mark Properties
    ...
    void reset() {
        ...
        _planetStardustPerLayer = CONSTANTS::DEFAULT_LAYER_SIZE;
    }
     ...
     */
    uint16_t getPlanetStardustPerLayer() const {
        return _planetStardustPerLayer;
    }
    
    /** 
     * Sets the planet mass required to win the game.
     */
    void setPlanetStardustPerLayer(uint16_t planetStardustPerLayer) {
        _planetStardustPerLayer = planetStardustPerLayer;
    }
