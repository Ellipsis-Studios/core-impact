...
private:
	...
	/** Timestamp for the start of a input press */
	cugl::Timestamp _fingerDownTimestamp;

	/** Whether immediately previous input instance pressed on the planet */
	bool _didPressPlanet;

	/** Whether user pressed on the planet for 3 seconds. This triggers planet layer lock-in. */
	bool _didLongPress;
