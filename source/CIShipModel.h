...
protected:
    ...
    std::shared_ptr<cugl::scene2::AnimationNode> _sprite;
...
#pragma mark Animation
     ...
     */
    std::shared_ptr<cugl::scene2::AnimationNode>& getSprite()   { return _sprite;   }
     ...
     */
    void    setSprite(const std::shared_ptr<cugl::scene2::AnimationNode>& value);
